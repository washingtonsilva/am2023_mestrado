---
title: "Análise Multivariada - Aula 1"
...
## Por que aprender a linguagem R? {.smaller}
...
- Cientistas e Analistas de dados mantêm todos os arquivos associados a um determinado projeto juntos e organizados em pastas — dados, scripts, 
relatórios etc. 

- Esta é uma prática tão sábia e comum que o RStudio tem suporte integrado 
para isso por meio dos `Projects`. 

- Os RStudio Projects tornam simples organizar seu trabalho em vários contextos, cada um com seu próprio diretório de trabalho e documentos de origem.
...
notebooks, quarto, R markdown etc.) ou o que for necessário para concluir seu projeto. 

- Todos os arquivos de um projeto agora estarão contidos no projeto 
RStudio e salvos na pasta do projeto.

- As configurações que fizemos no Slides 18 afetam o comportamento 
dos projetos.
