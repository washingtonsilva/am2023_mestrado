---
title: "Análise Multivariada - Aula 2"
...
- Modelagem Estatística: As duas Culturas
- Modelos de Regressão Linear: Inferência
- Modelos de Regressão Linear: Previsão
...
![Statistical Modelling: The Two Cultures](img/breiman_two.jpeg){#fig-two fig-align="center" width=80%}

[@breiman2001](https://projecteuclid.org/journals/statistical-science/volume-16/issue-3/Statistical-Modeling--The-Two-Cultures-with-comments-and-a/10.1214/ss/1009213726.full){target="_blank"}



## CART: Classification and Regression Trees

![CART (1984)](img/cart.jpeg){#fig-cart fig-align="center" width=80%}
...
- Na cultura científica tradicional, o interesse em geral está nas estimativas 
...
- Cultura: Ciência dos Dados/Aprendizagem de Máquina - **Previsão**
...
![Dados sobre Vendas e Publicidade](img/adver.png){#fig-adver fig-align="center" width=80%}
...
## Diversidade de Modelos de Regressão
...
![Esperança Condicional](img/condicional.png){#fig-mqogeom fig-align="center" width=70%}
...
- Regressão Linear Múltipla: Notação Matricial
...
![Geometria dos MQO](img/leastsq.png){#fig-mqogeom fig-align="center" width=60%}


## Geometria dos Mínimos Quadrados Ordinários

![A Reta de MQO e seus Resíduos](https://theeffectbook.net/the-effect_files/figure-html/describingrelationships-ols-resid-1.png){#fig-ols fig-align="center" width=50%}
...
- Se $E(Y|X = 5) = 10$ , e se o dado real é $(x = 5, y = 13)$, então a 
previsão é $\hat{y} = 10$ e o resíduo é:
...
- **H1**, **H2**, **H3** e **H4**
    ...
    - Garantem que os estimadores de MQO são os **melhores estimadores lineares 
      não viesados**, segundo o [Teorema de Gauss-Markov](https://en.wikipedia.org/wiki/Gauss%E2%80%93Markov_theorem){target="_blank"}. 
...
-  Não melhora as propriedades estatísticas do modelo. Não lida com 
assimetria, *outliers* ou linearização. 

- Transforma uma variável subtraindo sua média e dividindo por seu desvio 
padrão:
...
# teste de endogeneidade por omissao de variaveis
lmtest::resettest(modelo, power = 2:3, type = "fitted")

# teste de nao-linearidade
lmtest::resettest(modelo, power = 2:3, type = "regressor")
```
...
e selecionar as variáveis preditoras que devem ser mantidas. 

- O procedimento envolve, a partir do modelo contendo todas as variáveis preditoras ($X$), retirar cada uma  das variáveis preditoras do modelo e selecionar as que devem ser mantidas de acordo com algum critério, o mais 
usado é manter as variáveis que reduzem o Critério de Informação de Akaike 
(AIC).
...
DescTools::JarqueBeraTest(modelo_step$residuals, robust = TRUE))
```
...
$|vif| > 5$ e $|vif| > 10$ são critérios comuns para dizer se uma variável 
está causando multicolinearidade ou não.
