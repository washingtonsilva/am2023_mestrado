...
componentes principais como variáveis preditoras, ao invés das diveras 
...
e maio de 2018. Um dicionário dos dados é apresentado na @tbl-series.
...
confiança do coeficiente da variável `tax_rate`.). Entretanto, qual 
a estimativa fornecida pelo modelo de regressão múltipla, da redução 
média do preço de um imóvel devida a uma reduçào na taxa de imposto sobre 
a propriedade?
